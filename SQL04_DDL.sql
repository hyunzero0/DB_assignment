...
-- 3. TB_CATEGORY테이블의 NAME 컬럼에 PRIMARY KEY 를 생성하시오.
...
-- 컬럼명이 NAME 인 것은 마찬가지로 기존타입을 유지하면서 크기 20 으로 변경하시오.
...
-- CATEGORY_NAME 컬럼을 부모 값으로 참조하도록 FOREIGN KEY 를 지정하시오.
...
UPDATE VW_학생일반정보 SET STUDENT_NAME = '김현영' WHERE STUDENT_NO = 'A213046';
...
-- 최근 4년을 기준으로 수강 인원이 가장 많았던 3 과목을 찾는 구문을 작성해보시오.
SELECT *
FROM(
