...
-- CONCAT 사용해보기
SELECT CONCAT(CONCAT(CONCAT(DEPARTMENT_NAME, '의 정원은 '), CAPACITY), '명 입니다.') AS "학과별 정원"
FROM TB_DEPARTMENT;
...
--      그럼 춘 기술대학교 총장의 이름을 알아낼수 있는 SQL문장 작성하시오.
...
FROM TB_STUDENT
WHERE ABSENCE_YN = 'N' AND STUDENT_ADDRESS LIKE '%전주%' AND EXTRACT(YEAR FROM ENTRANCE_DATE) = 2002;